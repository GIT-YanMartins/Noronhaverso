  ...
  return (
    <main className="main-box">
      ...
      <section className='firstParagraph'>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi cum aliquid minus magnam reprehenderit consequatur aspernatur quia. Eaque esse dolorum quasi, eveniet voluptate non nesciunt aut hic maiores, quis beatae?</p>
      </section>

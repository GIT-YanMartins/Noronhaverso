...
O presente projeto insere-se no contexto de desenvolvimento de uma aplicação web imersiva voltada para o geoturismo virtual e a divulgação geocientífica. O objetivo é atuar na divulgação geocientífica do Arquipélago de Fernando de Noronha. A plataforma visa transpor as barreiras geográficas e financeiras que limitam o acesso físico ao arquipélago. Com isso, promove a democratização do conhecimento geológico e a conservação do patrimônio natural brasileiro.

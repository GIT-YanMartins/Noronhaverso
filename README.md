...
[cite_start]O presente projeto insere-se no contexto de desenvolvimento de uma aplicação web imersiva voltada para o geoturismo virtual e a divulgação geocientífica[cite: 7]. [cite_start]O objetivo é atuar na divulgação geocientífica do Arquipélago de Fernando de Noronha[cite: 7]. [cite_start]A plataforma visa transpor as barreiras geográficas e financeiras que limitam o acesso físico ao arquipélago[cite: 7]. [cite_start]Com isso, promove a democratização do conhecimento geológico e a conservação do patrimônio natural brasileiro[cite: 7].

---

## ✨ Funcionalidades Principais

* [cite_start]**Exploração Imersiva:** O usuário terá acesso a imagens de satélite, fotomosaicos, fotos e vídeos aéreos[cite: 10].
* [cite_start]**Visualização 3D:** A plataforma integra modelos digitais de terreno e modelos 3D[cite: 10]. [cite_start]Esses modelos permitem a visualização imersiva de afloramentos geológicos em alta resolução[cite: 26].
* [cite_start]**Acervo Geocientífico:** Disponibiliza textos explicativos e ilustrações sobre a geologia do Arquipélago de Fernando de Noronha[cite: 10]. [cite_start]Informa também sobre a história de formação do arquipélago[cite: 10].
...
* [cite_start]**Instituição:** Projeto desenvolvido na Universidade Federal da Bahia[cite: 1].
* [cite_start]**Departamento:** Vinculado à Pró-Reitoria de Extensão, Arte e Cultura[cite: 2].
* [cite_start]**Orientação:** Proponente Letícia Freitas Guimarães[cite: 4].
* [cite_start]**Programa:** Plano de trabalho de estudante bolsista de extensão[cite: 3]. [cite_start]Parte integrante do edital PIBIEx 2026-2027[cite: 4].
